...
import { getContrastYIQ, nav, route, pages as routePages, useRoute, getPXSize, getStatusBarHeight } from '@/duxapp/utils'
      ...
      option.showHeader ? <>
        ...
        {(show || absolute) && <View className={`Header${absolute ? ' Header--absolute' : ''}`}>
          ...
          >
            ...
            {
              renderHeader
                ? <View style={{ paddingRight: getPXSize(option.jiaonangWidth), height: headerHeight }}>{renderHeader}</View>
                :
                <View
